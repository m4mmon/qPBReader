...
qPBReaderComboBox::qPBReaderComboBox(const QString & isText, QWidget * ipParent) :
   QWidget(ipParent)
{
   ...
   pLabel->setObjectName("comboLabel");
   horizontalLayout->addWidget(pLabel);

   _pComboBox = new QComboBox(this);
   _pComboBox->setObjectName("comboSelector");
   _pComboBox->setEditable(false);
   horizontalLayout->addWidget(_pComboBox);
}

// -----------------------------------------------------------------------------

qPBReaderComboBox::~qPBReaderComboBox()
{
}
